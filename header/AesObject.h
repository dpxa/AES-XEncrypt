...
public:
    ...
    void subBytes(byte st[16]);
    void invSubBytes(byte st[16]);

    void shiftRows(byte st[16]);
    void invShiftRows(byte st[16]);

    void mixColumns(byte st[16]);
    void invMixColumns(byte st[16]);

    void Pad(std::vector<byte> &data);
    void Unpad(std::vector<byte> &data);
};
